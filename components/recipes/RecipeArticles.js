                                    ...
                                    <>
                                        <div className="col-span-12 relative">
                                            ...
                                            <div className="mt-6 mb-6 px-8 lg:p-0 text-black lg:2xl text-xl lg:w-2/3 w-full recipe-article">
                                                <InlineWysiwyg name="content" format="markdown" sticky>
                                                    <div dangerouslySetInnerHTML={{ __html: truncate( recipe.content.replace(/(<([^>]+)>)/gi, ""), 500, '...') }}></div>
                                                </InlineWysiwyg>
                                                <a href={`/recipes/${recipe.slug}`} className="text-xl lg:2xl pl-8 mt-8 lg:p-0 text-chinored hover:underline cursor-pointer block">Read More ></a>
                                            </div>
                                        </div>
