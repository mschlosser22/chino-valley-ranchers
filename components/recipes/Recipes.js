...
const recipeFooter = {
  ...
  description:
    "Explore our entire family of egg products, all of which are produced by healthy and happy, free range hens.",
...
const recipesTemp = [
  {
    ...
    content:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris blandit nisl quam, nec convallis libero fringilla vitae. Sed tincidunt a lorem ac faucibus. Integer efficitur est a risus.",
  },
  {
    ...
    content:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris blandit nisl quam, nec convallis libero fringilla vitae. Sed tincidunt a lorem ac faucibus. Integer efficitur est a risus consectetur elementum.",
  },
  {
    title: "Baked Eggs",
    video: {
...
const getArticleRecipes = (recipes) => {
  const results = recipes.filter(
    (recipe) => recipe.category == "recipe-article"
  );
  return results;
};
        ...
        >
          ...
          >
            <div className="max-w-6xl mx-auto">
              {/* Page Heading */}
              <div className="text-center pb-8 lg:py-24 max-w-5xl mx-auto px-8 lg:px-0">
              ...
              <div className="flex max-w-6xl mx-auto mb-8">
                <button
                  className={`w-full py-2 cursor-pointer ${
                    recipeCategory == "recipe-videos"
                      ? "bg-chinoblue text-white"
                      : "border-b-2 border-chinoblue text-chinoblue"
                  }`}
                  onClick={() => setRecipeCategory("recipe-videos")}
                >
                  <span className="sm:text-lg text-md tracking-wider uppercase font-ultra">
                    Video Recipes
                  </span>
                </button>
                <button
                ...
                >
                  <span className="font-ultra uppercase tracking-wider sm:text-lg text-md">
                    Recipe Articles
                  </span>
                </button>
              </div>
              ...
              {recipeCategory == "recipe-articles" && (
                <RecipeArticles
                  recipes={getArticleRecipes(parsedRecipes)}
                  recipeTag={recipeTag}
                />
              )}
            </div>
              ...
              <div className="flex max-w-6xl mx-auto mb-8">
                <button className="bg-chinoblue w-full py-2">
                  <a
                    ...
                    onClick={() => setRecipeCategory("recipe-videos")}
                  >
                    <span className="text-white sm:text-lg text-md tracking-wider uppercase font-ultra">
                      Video Recipes
                    </span>
                  </a>
                </button>
                <button className="border-b-2 border-chinoblue w-full py-2">
                  <a
                    ...
                    onClick={() => setRecipeCategory("recipe-articles")}
                  >
                    <span className="text-chinoblue font-ultra uppercase tracking-wider sm:text-lg text-md">
                      Recipe Articles
                    </span>
                  </a>
                </button>
