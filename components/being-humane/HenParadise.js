                ...
                {(progress, event) => (
                  <>
                    <Spring
                      ...
                      left={
                        scrollPositionOverHalf(progress)
                          ? `${progress * 4}rem`
                          : "-45rem"
                      }
                    >
                      {(styles) => (
                        <animated.div style={styles} className="relative">
                          <img src="https://res.cloudinary.com/dmfgntgym/image/fetch/f_auto/q_auto:eco/https://www.chinovalleyranchers.com//images/chicken-left.png" />
                        </animated.div>
                      )}
                    </Spring>
                  </>
                ...
                {(progress, event) => (
                  <>
                    <Spring
                      ...
                      bottom={
                        scrollPositionOverHalf(progress) ? `0rem` : "-30rem"
                      }
                    >
                      {(styles) => (
                        <animated.div style={styles} className="relative">
                          <img
                            src="https://res.cloudinary.com/dmfgntgym/image/fetch/f_auto/q_auto:eco/https://www.chinovalleyranchers.com//images/chicken-middle.png"
                  ...
                  {(progress, event) => (
                    <>
                      <Spring
                        ...
                        bottom={
                          scrollPositionOverHalfAlt(progress) ? `0rem` : "-7rem"
                        }
                        opacity={
                          scrollPositionOverHalfAlt(progress) ? `1` : "0"
                        }
                      >
                        {(styles) => (
                          <animated.div style={styles} className="relative">
                            <img src="https://res.cloudinary.com/dmfgntgym/image/fetch/f_auto/q_auto:eco/https://www.chinovalleyranchers.com//images/chicken-bubble.png" />
                          </animated.div>
                        )}
                      </Spring>
                    </>
                  ...
                  {(progress, event) => (
                    <>
                      ...
                      >
                        {(styles) => (
                          <animated.div style={styles} className="relative">
                            <img src="https://res.cloudinary.com/dmfgntgym/image/fetch/f_auto/q_auto:eco/https://www.chinovalleyranchers.com//images/chicken-right.png" />
                          </animated.div>
                        )}
                      </Spring>
                    </>
