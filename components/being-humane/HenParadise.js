export function HenParadise(props) {
    ...
    return(
     <div>
        <div className="relative lg:pt-16 pt-6  lg:-mt-12 -mt-32 bg-no-repeat bg-cover" style={{ backgroundImage: `url('/images/dirt-background.png')` }}>
            <div className="max-w-5xl mx-auto">
                
                {/* Page Heading */}
                <div className="text-center z-50 pt-24 lg:py-16 max-w-4xl mx-auto px-8 lg:px-0">
                ...
                <img src="/images/threeChickens.png"></img>
                </div>
            </div>
