                           ...
                           <div className="max-w-5xl mx-auto">
                               <div className="grid grid-cols-12">
                                    <div className="lg:col-span-5 md:col-span-6 col-span-12">
                                        <img src="/images/humanePictureFrame1.png" className="mx-auto md:m-0"></img>
                                    </div>
                                    <div className="lg:col-span-7 md:col-span-6 col-span-12">
                                        <p className="lg:text-2xl text-xl font-lato leading-normal md:pt-8 pt-8 md:pl-8 md:mx-0 mx-6 text-center lg:text-left">Raising chickens without cages, as well as free range and organic upbringings, typify our philosophy of treating all hens with kindness and respect. Research has shown that a comfortable low-stress environment throughout all stages of a chicken’s development makes for a happier and healthier life.</p>
                                    </div>
                                    <div className="lg:col-span-7 md:col-span-6 col-span-12">
                                        <p className="lg:text-2xl text-xl font-lato lg:pl-12 pt-8 pb-8 md:pb-0 leading-normal md:mx-0 mx-6 text-center lg:text-left">A few decades ago we developed a number of consistent systems for both our Pullet Farm (where we raise our chickens) and our Egg Ranch (where the mature hens lay their eggs). For example, we keep the same feed and water system in place from the Brood-House to the Grow-House and finally to the Lay-House. This makes things easy for our birds and provides familiarity throughout their lives.</p>
                                    </div>
                                    <div className="lg:col-span-5 md:col-span-6 col-span-12 lg:-mt-20 lg:pl-16">
                                        <img src="/images/humanePictureFrame2.png" className="mx-auto md:m-0"></img>
                                    </div>
                                </div>
                            </div>
                </div>
