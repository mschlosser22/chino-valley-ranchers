         ...
         <div className="relative pb-24 mt-4" style={{ backgroundImage: `url('/images/bg-paper.png')` }}>
            <div className="max-w-5xl mx-auto">
                ...
                <div className="lg:text-center pt-12 lg:py-16 max-w-4xl mx-auto px-8 lg:px-0">
                    ...
                    <p className="font-lato lg:text-xl tracking-wide leading-normal pb-12 font-bold lg:text-left">As egg ranchers for more than six decades, we are committed to using nutritious top quality feed for several important reasons. First, it helps keep our chickens healthy, active and content. Equally important, it has a direct effect on the quality and nutritional value of Chino Valley Ranchers eggs.</p>
                    <p className="font-lato lg:text-xl tracking-wide leading-normal pb-12 font-bold lg:text-left">As a leader in the specialty egg industry, we take great pride in producing egg varieties—organic, omega-3, vegetarian, soy free and more—with the highest nutritional values and the best taste. Precision feed formulation plays a major role in this.</p>
                    <p className="font-lato lg:text-xl tracking-wide leading-normal font-bold pb-12 lg:pb-0 lg:text-left">It all starts with the finest grains. Chino Valley Ranchers uses only top grade corn, soybean (except for our Organic Soy Free), alfalfa, flax seed and other select seeds, plus limestone meal for essential minerals. All of our organic grains come from non-genetically-modified seeds and are grown in certified organic fields that are free of pesticide.</p>
                </div>
                <div>
