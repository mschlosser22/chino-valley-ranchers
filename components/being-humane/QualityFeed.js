         ...
         <div className="relative pb-44 mt-4" style={{ backgroundImage: `url('/images/bg-paper.png')` }}>
            <div className="max-w-5xl mx-auto">
                ...
                <div>
                    ...
                    <p className="lg:text-3xl text-xl font-ultra text-center max-w-4xl py-9 mx-auto tracking-wide">As you would expect, <br /> our natural feed formulations <br />
