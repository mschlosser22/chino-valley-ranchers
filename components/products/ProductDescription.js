            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-12 pt-12 pb-12 lg:pb-24 relative px-8 xl:px-0 gap-4">
                    ...
                    <div className="col-span-12">
                        <h1 className="text-3xl lg:text-7xl text-chinored font-ultra uppercase tracking-wide lg:mb-4 text-center"><InlineText name="name" /></h1>
                    </div>
                    {/* Content */}
                ...
                <div className="grid grid-cols-12 relative px-8 xl:px-0 gap-4">
                    ...
                    <div className="col-span-12 lg:col-span-5 pl-0 lg:pl-12">
                        ...
                        <div className="pb-12 lg:pb-28">
                            <h2 className="ml-0 lg:ml-14 text-2xl lg:text-5xl font-ultra tracking-wide pb-8 text-gray-900"><InlineText name="category" /></h2>
                            <img src="/images/orangeSeperator.jpg" alt="border" className="pb-8" />
                            {props.tags.map( (tag, index) => (
                                <div key={index}>
                                    <h3 className="font-ultra tracking-wide ml-0 lg:ml-14 text-gray-900 text-xl lg:text-4xl">{tag}</h3>
                                </div>
                            ))}
                        </div>
                        {/* Button */}
                    ...
                    <div className="col-span-12 lg:col-span-7 grid grid-cols-12">
                        ...
                        <div className="col-span-12 text-right flex flex-row-reverse mt-12 mb-12">
                            <a className="border-b-4 border-chinoblue lg:text-2xl text-chinoblue font-ultra tracking-wide cursor-pointer" onClick={() => setOpen(true)}>View Nutrition Info</a>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div>
                        <div className="mt-3 text-center sm:mt-5">
                            <div className="mt-2">
                                <img src={props.nutrition.src} alt={props.nutrition.alt} />
                            </div>
                        </div>
                    </div>
