  ...
  export function CtaScratch(props) {
    ...
    return(
      <div className={`relative ${inView ? 'block' : 'hidden' } ${ctaHeight ? 'max-h-screen lg:max-h-max' : 'max-h-0' }`}>
        <div className={`bg-scratchBanner bg-cover bg-center bg-no-repeat pt-4 text-white z-60 xl:h-full lg:h-64 sm:h-48 xs:h-32 h-16 top-0 transform transition duration-700 ease-in-out origin-top ${isLoaded ? 'scale-y-100' : 'scale-y-0'} ${ctaHeight ? 'h-auto' : 'h-0' }`}>
            <div className="grid grid-cols-2 3xl:gap-80 2xl:gap-64 xl:gap-56 lg:gap-56 md:gap-36 sm:gap-28 gap-16">
                ...
                <div className="col-span-1">
                    <div class="flex relative">
                        <img src="/images/scratch.png" className="3xl:h-80 xl:h-64 lg:h-48 md:h-44 sm:h-36 sm:h-32 xs:h-28 h-16 z-10" />
                        {/* <Image
                        ...
                        /> */}
                        <div>
                            <div className="3xl:-ml-8 2xl:-ml-7 xl:-ml-6 lg:-ml-5 md:-ml-4 sm:-ml-3 -ml-2 absolute bottom-0 3xl:mb-20 2xl:mb-14 xl:mb-10 lg:mb-10 md:mb-8 sm:mb-6 mb-2">
