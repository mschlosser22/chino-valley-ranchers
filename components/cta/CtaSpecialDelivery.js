      ...
      >
        <div className="flex justify-center xl:ml-96 lg:ml-72 md:ml-36 sm:ml-48">
          <div className="absolute left-2">
            <img
              src="https://res.cloudinary.com/dmlnena1u/image/fetch/q_auto:eco/https://www.chinovalleyranchers.com//images/twoGuysBanner.png"
          ...
          <div className="absolute top-0 2xl:left-[625px] xl:left-[485px] lg:left-[420px] md:left-[280px] sm:left-[260px] left-4">
            <img
              src="https://res.cloudinary.com/dmlnena1u/image/fetch/q_auto:eco/https://www.chinovalleyranchers.com/images/museBanner.gif"
          ...
          <div className="absolute bottom-[5] right-4">
            <img
              src="https://res.cloudinary.com/dmlnena1u/image/fetch/q_auto:eco/https://www.chinovalleyranchers.com//images/womanBanner.png"
