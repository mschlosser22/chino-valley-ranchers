                ...
                <div className="relative w-full overflow-visible egg-slider-bg">
                    ...
                    >
                        {props.slides.map( (slide, index) => (
                            <div key={index} className="px-8 xl:px-0 text-left lg:text-center lg:text-left">
                                ...
                                <div className="max-w-5xl mx-auto">
                                    <div className="grid grid-cols-12 lg:gap-10">
                                        <div className="col-span-12 lg:col-span-5 font-ultra tracking-wide -mt-10">
                                            <h3 className="text-3xl sm:text-heading sm:leading-heading-lh sm:mt-8 lg:mt-0 text-chinored mb-8">{slide.name}</h3>
