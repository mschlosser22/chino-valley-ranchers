...
export function EggSlider(props) {
    ...
    return(
        ...
        <div className="relative z-10" style={{ backgroundImage: `url('/images/bg-paper.png')` }}>
            <div className="min-h-[615px] sm:min-h-[775px] lg:min-h-[650px]" >
                ...
                <div className="relative w-full overflow-visible egg-slider-bg">
                    ...
                    >
                        {props.slides.map( (slide, index) => (
                            <div key={index} className="px-8 xl:px-0 text-left lg:text-left lg:text-left">
                                ...
                                <div className="max-w-5xl mx-auto">
                                    <div className="grid grid-cols-12 lg:gap-10">
                                        <div className="col-span-12 lg:col-span-5 font-ultra tracking-wide -mt-10">
                                            <h3 className="text-3xl sm:text-heading sm:leading-heading-lh sm:mt-8 lg:mt-0 text-chinored lg:mb-8">{slide.name}</h3>
                                            <p className="text-gray-900 text-xl lg:text-4xl">{slide.heading}</p>
                                            <p className="text-gray-900 text-xl lg:text-4xl pb-4 lg:pb-8">{slide.subheading}</p>
                                        </div>
                                        <div className="col-span-12 lg:col-span-7 font-lato tracking-wide text-lg lg:text-3xl">
                                            <p className="sm:leading-body pb-4 lg:pb-0">{slide.content}</p>
                                        </div>
                                        {/* Icons */}
