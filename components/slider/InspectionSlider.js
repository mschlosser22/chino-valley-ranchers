                ...
                <div className="col-span-12 lg:col-span-9 font-ultra text-3xl sm:leading-body lg:text-6xl tracking-wide text-white uppercase pt-10">
                  ...
                  <div className="pt-12 pb-20 relative lg:right-36 px-8 sm:px-12 lg:px-0">
                    <img
                      ...
                      src="https://res.cloudinary.com/dmlnena1u/image/fetch/q_auto:eco/https://www.chinovalleyranchers.com//images/inspection.png"
                      alt="inspection point"
                    />
                    <img
                      className="lg:hidden"
                      src="https://res.cloudinary.com/dmlnena1u/image/fetch/q_auto:eco/https://www.chinovalleyranchers.com//images/inspection-mobile.png"
                      alt="inspection point"
                    />
                  </div>
                </div>
