...
export function ContentWithImage({ data, index }) {
  return (
    <div
      className="relative pt-8 -mt-24 pb-12 bg-no-repeat bg-cover z-40"
      style={{
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-12 pt-12 lg:pt-36 pb-12 lg:pb-24">
          <div className="col-span-12 lg:col-span-8 text-center lg:text-left px-8 xl:px-0 xl:pr-8">
            <h3 className="text-3xl lg:text-7xl text-chinored font-ultra uppercase tracking-wide lg:mb-4">
              <InlineTextarea name="content.heading" />
            </h3>
            <div className="pb-16">
...
export const contentWithImageBlock = {
  ...
  template: {
    ...
    defaultItem: {
      content: {
        background:
          "https://res.cloudinary.com/dmfgntgym/image/fetch/f_auto/q_auto:eco/https://www.chinovalleyranchers.com//images/dirt-background.png",
        content: {
