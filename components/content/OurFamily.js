      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-12 pt-12 lg:pt-36 pb-12 lg:pb-24 relative px-8 xl:px-0 gap-4">
          ...
          <div className="col-span-12 lg:col-span-6 flex lg:block justify-center">
            <img
              src={`https://res.cloudinary.com/dmfgntgym/image/fetch/f_auto/q_auto:eco/https://www.chinovalleyranchers.com/${props.data.image.src}`}
              alt={props.data.image.alt}
            />
          </div>
          {/* Right/Content */}
          <div className="col-span-12 lg:col-span-6 relative">
            <p className="font-lato lg:text-3xl sm:leading-body tracking-wide lg:mb-8 pt-8 text-left">
              <InlineTextarea name="content" />
            </p>
            <div className="flex lg:justify-center lg:block">
              <Button
                button={props.data.button}
                classes={`mt-12 xl:absolute lg:bottom-0 xl:right-0`}
              />
            </div>
          </div>
        </div>
