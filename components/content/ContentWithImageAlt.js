      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-12 pt-24 sm:pt-36 pb-12 sm:pb-24">
          <div className="col-span-12 sm:col-span-8 text-left px-8 xl:px-0 xl:pr-8">
            <h3 className="text-3xl sm:text-4xl lg:text-7xl text-white font-ultra uppercase tracking-wide mb-4 lg:mb-12 text-center">
          ...
          <div className="col-span-12 sm:col-span-4 relative flex flex-col-reverse sm:block">
            ...
            <ScrollPercentage>
              {({ percentage, ref, entry }) => (
                <div
                  ref={ref}
                  className="relative sm:absolute sm:top-1/2 md:-top-24 sm:right-0 flex justify-center sm:block pt-12 sm:pt-0 px-10 lg:px-0"
                >
                  <Spring
                  ...
                  >
                    {(styles) => (
                      <animated.div style={styles}>
                        <img
                          src={`https://res.cloudinary.com/dmlnena1u/image/fetch/q_auto:eco/https://www.chinovalleyranchers.com/${props.data.calloutImage.src}`}
...
const paragraph_template = {
  label: "Paragraph",
  defaultItem: {
    text: ["Some default paragraph text here"],
  },
  /*
