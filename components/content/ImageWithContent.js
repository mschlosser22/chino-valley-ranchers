      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-12 pt-12 lg:pt-36 pb-0 lg:pb-24 relative px-0 xl:px-0">
          ...
          <div className="col-span-12 lg:col-span-6 relative">
            <p className="font-lato lg:text-3xl sm:leading-body tracking-wide mb-8 px-8 xl:px-0">
              <InlineTextarea name="content" />
            </p>
            <div
              className="w-full hidden lg:flex lg:block justify-center max-w-xs mx-auto lg:max-w-full"
              ref={ref}
            >
              {/* Animation Test */}
              <ScrollPercentage
                ...
                onChange={(percentage, entry) =>
                  determineLeft(percentage.toPrecision(2) * 100)
                }
              >
                <animated.div style={styles}>
                  <img
                    src={`https://res.cloudinary.com/dmfgntgym/image/fetch/f_auto/q_auto:eco/https://www.chinovalleyranchers.com/${props.data.leftImage.src}`}
            ...
            <div className="w-full lg:hidden justify-center mx-auto relative -mb-10">
              <a href="/about-pasture-raised" className="block">
                <img
                  src={`https://res.cloudinary.com/dmfgntgym/image/fetch/f_auto/q_auto:eco/https://www.chinovalleyranchers.com/${props.data.leftImageMobile.src}`}
          ...
          <div className="col-span-12 lg:col-span-6 hidden lg:flex lg:block justify-center">
            <div className="max-w-xs mx-auto lg:max-w-full">
              ...
              <ScrollPercentage
                as="div"
                onChange={(percentage, entry) =>
                  determineSign(percentage.toPrecision(2) * 100)
                }
              >
                <animated.div style={stylesSign}>
                  <animated.div style={stylesSignScale}>
                    ...
                    >
                      <img
                        src={`https://res.cloudinary.com/dmfgntgym/image/fetch/f_auto/q_auto:eco/https://www.chinovalleyranchers.com/${props.data.rightImage.src}`}
          ...
          <div className="col-span-12 xl:absolute bottom-0 right-0 xl:bottom-36 hidden lg:grid grid-cols-3 justify-around pt-20 divide-x divide-red-500 text-center xl:max-w-4xl xl:mr-0 px-8 xl:px-0">
            {props.data.absoluteContent.map((paragraph, index) => (
              <p
                key={index}
                className="font-ultra text-xl lg:text-4xl tracking-wide px-2 lg:px-0 leading-none lg:leading-9"
              >
                {paragraph}
              </p>
            ))}
