          ...
          >
            <div className="max-w-6xl mx-auto">
              <div className="text-center lg:pt-20 pb-8  max-w-5xl mx-auto px-8 lg:px-0">
                <h1
                  id="ourFeed"
                  className="text-2xl lg:text-5xl text-chinored font-ultra uppercase tracking-wide lg:leading-tight lg:mb-20 mb-6 lg:px-12"
                >
            ...
            <div className="max-w-5xl mx-auto">
              <div className="grid grid-cols-12 gap-0 lg:px-0 px-8">
                        ...
                        <>
                          ...
                          >
                            {(styles) => (
                              ...
                              >
                                <img src="https://res.cloudinary.com/dmfgntgym/image/fetch/f_auto/q_auto:eco/https://www.chinovalleyranchers.com//images/SVG/burst.svg" />
                              </animated.div>
                            )}
                          </Spring>
                          <Spring
                            ...
                            left={
                              scrollPositionOverHalf(progress) == false &&
                              scrollPositionEven(progress)
                                ? "1.5rem"
                                : "0rem"
                            }
                          >
                            {(styles) => (
                              ...
                              >
                                <img src="https://res.cloudinary.com/dmfgntgym/image/fetch/f_auto/q_auto:eco/https://www.chinovalleyranchers.com//images/SVG/egg.svg" />
                              </animated.div>
                            )}
                          </Spring>
                        </>
                ...
                <div className="lg:col-span-3 sm:col-span-4 col-span-12 lg:w-56 w-32 md:mx-0 mx-auto pt-4">
                  <img
                    src="https://res.cloudinary.com/dmfgntgym/image/fetch/f_auto/q_auto:eco/https://www.chinovalleyranchers.com//images/usdaOrganic.png"
                    className=""
                  ></img>
                </div>
              </div>
