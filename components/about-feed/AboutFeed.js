                        ...
                        >
                          {(styles) => (
                            <animated.div style={styles}>
                              <img
                                id="eat"
                                src={`https://res.cloudinary.com/dmlnena1u/image/fetch/q_auto:eco/https://www.chinovalleyranchers.com/${props.imageLeft.src}`}
                    ...
                    {(progress, event) => (
                      ...
                      >
                        {(styles) => (
                          ...
                          >
                            <img src="https://res.cloudinary.com/dmlnena1u/image/fetch/q_auto:eco/https://www.chinovalleyranchers.com//images/seeing-believingArrow.png" />
                          </animated.div>
                        )}
                      </Spring>
                    )}
