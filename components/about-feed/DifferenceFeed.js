...
export function DifferenceFeed() {
    return (
        <div>
          <div className="relative lg:pt-8 pt-12 z-40 lg:-mt-12 -mt-16 bg-no-repeat bg-cover" style={{ backgroundImage: `url('/images/bg-orangeEgg.jpg')` }}>
            ...
            <div className="lg:flex block lg:justify-between max-w-5xl lg:pl-14 mx-auto">
                ...
                <div className="lg:-mb-12 lg:ml-12  mb-12">
