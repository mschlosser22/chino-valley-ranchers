        ...
        >
          ...
          <div className="lg:flex block lg:justify-between max-w-5xl lg:pl-14 mx-auto">
            ...
            <div className="lg:-mb-12 lg:ml-12 z-30 mb-12">
              <img
                src="https://res.cloudinary.com/dmfgntgym/image/fetch/f_auto/q_auto:eco/https://www.chinovalleyranchers.com//images/2eggs.png"
              ...
              {(progress, event) => (
                ...
                >
                  {(styles) => (
                    ...
                    >
                      <img src="https://res.cloudinary.com/dmfgntgym/image/fetch/f_auto/q_auto:eco/https://www.chinovalleyranchers.com//images/SVG/hand.svg" />
                    </animated.div>
                  )}
                </Spring>
              )}
