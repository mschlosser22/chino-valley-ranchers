          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-12 lg:gap-8 pt-20 md:mx-auto px-8">
              <div className="md:col-span-5 col-span-12">
                <h1
                  id="eggsMade"
                  className="text-2xl lg:text-5xl text-chinoblue lg:leading-tight font-ultra uppercase tracking-wide mb-6"
                >
                ...
                <Scene duration={400} triggerElement="#eggsMade">
                  {(progress, event) => (
                    <Spring
                      ...
                      to={{
                        transform: `rotate(${progress * 10 - 10}deg) scale(${
                          (progress + 9) / 10
                        })`,
                      }}
                    >
                      {(styles) => (
                        <animated.div style={styles}>
                          <img src="https://res.cloudinary.com/dmfgntgym/image/fetch/f_auto/q_auto:eco/https://www.chinovalleyranchers.com//images/bowl-of-eggs.png"></img>
                        </animated.div>
                      )}
                    </Spring>
                  )}
              ...
              {props.list.map((item, index) => (
                <div
                  key={index}
                  className="col-span-12 grid grid-cols-12 pt-4 sm:pt-12 lg:pt-0"
                >
