        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-12">
            ...
            <div className="lg:col-span-4 col-span-12 lg:-mt-12 mx-auto">
              ...
              />
              <img
                src={`https://res.cloudinary.com/dmfgntgym/image/fetch/f_auto/q_auto:eco/https://www.chinovalleyranchers.com/${props.imageRightAlt.src}`}
                className="lg:-ml-16 lg:-mt-2 -mt-0 -ml-0 w-52 lg:w-full"
                alt={props.imageRightAlt.alt}
              />
            </div>
          </div>
