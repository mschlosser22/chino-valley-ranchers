...
export function Studies() {
    return (
        <div>
            <div className="lg:pb-20 pb-12 mt-24 max-w-6xl mx-auto px-8 lg:px-0 text-center">
                <div className="max-w-3xl mx-auto pb-4">
                    <img src="/images/chickens25.jpg"></img>
                </div>
                <h1 className="text-2xl lg:text-4xl text-black font-ultra uppercase tracking-wider">Studies have found that battery hens have a 
                ...
                <img src="/images/redSeperator.png" className="pt-6 lg:mb-52 mb-12 mx-auto lg:w-3/5 w-full"></img>
                <h1 className="font-ultra lg:text-6xl text-3xl text-center text-chinored uppercase tracking-wide lg:pb-16 pb-8">California Free Range <br className="lg:block hidden" />vs. The Other Guys</h1>
                <div className="max-w-3xl mx-auto lg:mb-24 mb-16">
                    <p className="font-lato lg:text-2xl tracking-wider lg:mx-0 mx-14 text-center text-chinodarkblue">Cage free farming is the standard in the humane treatment of chickens. As a result, we don’t believe that any other technique is acceptable. Other egg providers attempt to produce eggs on a mass scale, keeping their chickens in large buildings without direct access to the outdoors.</p>
