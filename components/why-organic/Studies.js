                  ...
                  {(styles) => (
                    <animated.div style={styles} className="h-56 flex relative">
                      <img
                        ...
                        src="https://res.cloudinary.com/dmlnena1u/image/fetch/q_auto:eco/https://www.chinovalleyranchers.com//images/SVG/chicken-middle-two.svg"
                      />
                    </animated.div>
                  )}
                </Spring>
          ...
          <div className="max-w-3xl mx-auto lg:mb-24 mb-16">
            {props.list.map((item, index) => (
              <div>
                ...
                <img
                  src="https://res.cloudinary.com/dmlnena1u/image/fetch/q_auto:eco/https://www.chinovalleyranchers.com//images/blueSeperator.jpg"
