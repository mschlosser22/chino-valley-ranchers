...
export function WhyOrganic(props) {
    return (
    <div>
        <div className="relative z-40 pt-8 lg:-mt-2 -mt-24 bg-no-repeat bg-cover" style={{ backgroundImage: `url('/images/bg-paper-edge.png')` }}>
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="lg:text-center text-left z-40 pt-8 lg:pt-20 pb-8 lg:py-24 max-w-5xl mx-auto">
                        ...
                        <div className="font-lato lg:text-2xl tracking-wide lg:mx-52 mx-8 lg:text-left"><InlineTextarea name="subheading" /></div>
                    </div>
                </div>
        </div>
    </div>
