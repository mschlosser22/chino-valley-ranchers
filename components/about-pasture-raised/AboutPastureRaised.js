          ...
          >
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center z-50 pt-8 lg:pt-20 pb-8 lg:py-24 max-w-5xl mx-auto px-8 lg:px-0">
                <h1 className="text-3xl lg:text-7xl text-chinored font-ultra uppercase tracking-wide lg:mb-12 mb-6">
              ...
              <div className="max-w-5xl mx-auto">
                      ...
                      <>
                        ...
                        >
                          {(styles) => (
                            ...
                            >
                              <img
                                src="https://res.cloudinary.com/dmlnena1u/image/fetch/q_auto:eco/https://www.chinovalleyranchers.com//images/darnGoodEgg-Img.png"
                                alt=""
                ...
                <div className="flex justify-center">
                  <p className="text-lg lg:text-3xl text-chinoblue font-ultra tracking-wide text-center transform -rotate-2">
                    free range & <br />
                    <span>ready to roam</span>
                  </p>
                  <img
                    src="https://res.cloudinary.com/dmlnena1u/image/fetch/q_auto:eco/https://www.chinovalleyranchers.com//images/freeRangeArrow.png"
