...
export default function Products({ file, isPreview, products }) {
  ...
  const formConfig = {
    id: '../../content/products/veg-a-fed-omega-3.json',
    initialValues: file,
    label: 'Products Page',
    fields: [
...
export const getStaticProps = async function({
  ...
  if (preview) {
    ...
    ...previewData,
    fileRelativePath: 'content/products/veg-a-fed-omega.json',
    parse: parseJson,
    isPreview: true,
    })
  }
  ...
  return {
    props: {
      ...
      preview: false,
      file: {
        fileRelativePath: 'content/products/veg-a-fed-omega-3.json',
        data: (await import('../../content/products/veg-a-fed-omega-3.json')).default,
      }
    },
  }
