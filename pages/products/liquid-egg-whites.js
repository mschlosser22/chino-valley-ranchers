...
export default function Products({ file, isPreview, products }) {
  ...
  const formConfig = {
    id: '../../content/products/liquid-egg-whites.json',
    initialValues: file,
    label: 'Products Page',
    fields: [
      {
...
export const getStaticProps = async function({
  ...
  if (preview) {
    ...
    ...previewData,
    fileRelativePath: 'content/products/liquid-egg-whites.json',
    parse: parseJson,
    isPreview: true,
    })
  }
  ...
  return {
    props: {
      ...
      file: {
        fileRelativePath: 'content/products/liquid-egg-whites.json',
        data: (await import('../../content/products/liquid-egg-whites.json')).default,
      }
    },
  }
