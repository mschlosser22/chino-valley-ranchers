...
export default function Products({ file, isPreview, products }) {
  ...
  const formConfig = {
    id: '../../content/products/organic-omega-3.json',
    initialValues: file,
    label: 'Products Page',
    fields: [
...
export const getStaticProps = async function({
  ...
  if (preview) {
    ...
    ...previewData,
    fileRelativePath: 'content/products/organic-omega-3.json',
    parse: parseJson,
    isPreview: true,
    })
  }
  ...
  return {
    props: {
      ...
      file: {
        fileRelativePath: 'content/products/organic-omega-3.json',
        data: (await import('../../content/products/organic-omega-3.json')).default,
      }
    },
  }
