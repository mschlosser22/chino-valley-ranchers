...
export default function Products({ file, isPreview, products }) {
  ...
  const formConfig = {
    id: '../../content/products/pasture-raised-organic.json',
    initialValues: file,
    label: 'Products Page',
    fields: [
      {
...
export const getStaticProps = async function({
  ...
  if (preview) {
    ...
    ...previewData,
    fileRelativePath: 'content/products/pasture-raised-organic.json',
    parse: parseJson,
    isPreview: true,
    })
  }
  ...
  return {
    props: {
      ...
      file: {
        fileRelativePath: 'content/products/pasture-raised-organic.json',
        data: (await import('../../content/products/pasture-raised-organic.json')).default,
      }
    },
  }
