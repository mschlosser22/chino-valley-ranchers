...
export default function Products({ file, isPreview, products }) {
  ...
  const formConfig = {
    id: '../../content/products/organic-omega-3-soy-free.json',
    initialValues: file,
    label: 'Products Page',
    fields: [
...
export const getStaticProps = async function({
  ...
  if (preview) {
    ...
    ...previewData,
    fileRelativePath: 'content/products/organic-omega-3-soy-free.json',
    parse: parseJson,
    isPreview: true,
    })
  }
  ...
  return {
    props: {
      ...
      file: {
        fileRelativePath: 'content/products/organic-omega-3-soy-free.json',
        data: (await import('../../content/products/organic-omega-3-soy-free.json')).default,
      }
    },
  }
