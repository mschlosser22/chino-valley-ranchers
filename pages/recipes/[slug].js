      ...
      <div className={`relative`}>
        ...
        <InlineForm form={form}>
          <article className="prose lg:prose-xl pt-48 pb-24 max-w-5xl mx-auto text-left px-8 lg:px-0">
            {file.data.image ? (
              <img
                src={`https://res.cloudinary.com/dmlnena1u/image/fetch/f_auto/q_auto:eco/https://www.chinovalleyranchers.com/${file.data.image.src}`}
...
export async function getStaticPaths() {
  ...
  const contentDir = "content/recipes/";
...
export const getStaticProps = async function ({
  ...
  if (preview) {
    return getGithubPreviewProps({
      ...previewData,
      fileRelativePath: `content/recipes/${params.slug}.json`,
      parse: parseJson,
      //isPreview: true,
      /*file: {
  ...
  return {
    props: {
      ...
      preview: false,
      file: {
        fileRelativePath: `content/recipes/${params.slug}`,
        data: (await import(`../../content/recipes/${params.slug}`)).default,
      },
    },
  };
};
